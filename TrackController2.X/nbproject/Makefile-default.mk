...
SOURCEFILES_QUOTED_IF_SPACED=modbus/General.c modbus/Init.c modbus/Interrupts.c modbus/PetitModbus.c modbus/PetitModbusPort.c modbus/PetitRegConstant.c Peripherals/config.c Peripherals/interrupt_manager.c Peripherals/pin_manager.c Peripherals/tmr2.c Peripherals/tmr1.c main.c comhandler.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/modbus/General.p1 ${OBJECTDIR}/modbus/Init.p1 ${OBJECTDIR}/modbus/Interrupts.p1 ${OBJECTDIR}/modbus/PetitModbus.p1 ${OBJECTDIR}/modbus/PetitModbusPort.p1 ${OBJECTDIR}/modbus/PetitRegConstant.p1 ${OBJECTDIR}/Peripherals/config.p1 ${OBJECTDIR}/Peripherals/interrupt_manager.p1 ${OBJECTDIR}/Peripherals/pin_manager.p1 ${OBJECTDIR}/Peripherals/tmr2.p1 ${OBJECTDIR}/Peripherals/tmr1.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/comhandler.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/modbus/General.p1.d ${OBJECTDIR}/modbus/Init.p1.d ${OBJECTDIR}/modbus/Interrupts.p1.d ${OBJECTDIR}/modbus/PetitModbus.p1.d ${OBJECTDIR}/modbus/PetitModbusPort.p1.d ${OBJECTDIR}/modbus/PetitRegConstant.p1.d ${OBJECTDIR}/Peripherals/config.p1.d ${OBJECTDIR}/Peripherals/interrupt_manager.p1.d ${OBJECTDIR}/Peripherals/pin_manager.p1.d ${OBJECTDIR}/Peripherals/tmr2.p1.d ${OBJECTDIR}/Peripherals/tmr1.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/comhandler.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/modbus/General.p1 ${OBJECTDIR}/modbus/Init.p1 ${OBJECTDIR}/modbus/Interrupts.p1 ${OBJECTDIR}/modbus/PetitModbus.p1 ${OBJECTDIR}/modbus/PetitModbusPort.p1 ${OBJECTDIR}/modbus/PetitRegConstant.p1 ${OBJECTDIR}/Peripherals/config.p1 ${OBJECTDIR}/Peripherals/interrupt_manager.p1 ${OBJECTDIR}/Peripherals/pin_manager.p1 ${OBJECTDIR}/Peripherals/tmr2.p1 ${OBJECTDIR}/Peripherals/tmr1.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/comhandler.p1

# Source Files
SOURCEFILES=modbus/General.c modbus/Init.c modbus/Interrupts.c modbus/PetitModbus.c modbus/PetitModbusPort.c modbus/PetitRegConstant.c Peripherals/config.c Peripherals/interrupt_manager.c Peripherals/pin_manager.c Peripherals/tmr2.c Peripherals/tmr1.c main.c comhandler.c
...
${OBJECTDIR}/comhandler.p1: comhandler.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/comhandler.p1.d 
	@${RM} ${OBJECTDIR}/comhandler.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/comhandler.p1  comhandler.c 
	@-${MV} ${OBJECTDIR}/comhandler.d ${OBJECTDIR}/comhandler.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/comhandler.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
