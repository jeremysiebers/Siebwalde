...
namespace SiebwaldeApp
{
    ...
    public partial class FiddleYardForm : Form
    {
        ...
        public Image SeinGreen = SiebwaldeApp.Properties.Resources.SeinGreen.ToBitmap();
        public Image SeinRed = SiebwaldeApp.Properties.Resources.SeinRed.ToBitmap();
        public Image SeinGreen270 = SiebwaldeApp.Properties.Resources.SeinGreen.ToBitmap();
        public Image SeinRed270 = SiebwaldeApp.Properties.Resources.SeinRed.ToBitmap();
        public Image Train = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.TrainWithWagon.ToBitmap()), PBHeight));
        public Image Train90 = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.TrainWithWagon.ToBitmap()), PBHeight));
        public Image Train270 = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.TrainWithWagon.ToBitmap()), PBHeight));
        public Image Active = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.StopSign.ToBitmap()), PBHeight));
        public Image Inline = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.Arrow.ToBitmap()), PBHeight));
        public Image HalfTrain = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.HalfTrainWithWagon.ToBitmap()), PBHeight));
        public Image HalfTrain270 = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.HalfTrainWithWagon.ToBitmap()), PBHeight));
        public Image HalfWagon = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.HalfWagon.ToBitmap()), PBHeight));
        public Image HalfWagon90 = CropBitmap.Crop(ScaleBitmap.Scale(CropBitmap.Crop(SiebwaldeApp.Properties.Resources.HalfWagon.ToBitmap()), PBHeight));
        /*#--------------------------------------------------------------------------#*/
