...
- Consequence: the Workflow v1 bootstrap is complete through permission normalization and the Active State mechanism; only broader documentation-drift repair (and a final end-to-end workflow eval / PR-readiness audit) remains.
