...
unsigned char SwInput_Old = 0;

unsigned int Servo_Pos = SERVO_MIDDLE;
unsigned int Servo_Pos_H = 0xFB;
unsigned int Servo_Pos_L = 0xE0;
...
isr(void) // Here the interrupt function
{
    ...
    {
        ServoOut = !ServoOut;
//        Pulses++; // increment interrupt frequency counter
//
//        if (Pulses >= 13) // 13 pulses for 50 Hz servo pulse
//        {
//            Pulses = 0;
//            TMR1H = Servo_Pos >> 8;
//            TMR1L = Servo_Pos;
...
//                Servo_Pos++;
//            }
//            else if ((SwInput == Off) && (Servo_Pos > SERVO_RIGHT))
//            {
//                Servo_Pos--;
//            }
//
//            //Servo_Pos_H = Servo_Pos >> 8;
//            //Servo_Pos_L = Servo_Pos;
//
//        }
