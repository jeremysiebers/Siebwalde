...
class State:
    ...
    def ConfigureSlave(self, TrackBackPlaneID, AmplifierLatchSet, TrackAmplifierId, Mode):
        ...
        if(self.RunSlaveConfig == 0):
            ...
            self.DataCommunication.WriteUDP(EnumCommand.MODBUS, self.ModbusMaster)
        ...
        if(self.RunSlaveConfig == 1):
            if(self.DataCommunication.Trackamplifiers[0].InputReg[0] == EnumSlaveConfig.OK):
        ...
        if(self.RunSlaveConfig == 2):
            if(self.DataCommunication.Trackamplifiers[0].InputReg[0] == EnumSlaveConfig.IDLE):
    ...
    def EnableTrackamplifiers(self):
        ...
        if(self.EnableSlaveConfig == 2):
            if(self.DataCommunication.Trackamplifiers[0].InputReg[0] == EnumSlaveConfig.IDLE):
                self.DataCommunication.WriteUDP(EnumCommand.ETHERNET_T, EnumEthernetT.INIT_PHASE_FALSE)
