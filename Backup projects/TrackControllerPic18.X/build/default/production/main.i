...
# 911 "./mcc_generated_files/pin_manager.h"
...
static _Bool updateTick = 0;
static uint32_t tBootWaitTimeCnt = 1;
static _Bool booted = 0;
static _Bool justSendData = 0;
...
_Bool compareDataToSend(const uint8_t *arr1, const uint8_t *arr2, uint8_t size);
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if(PORTGbits.RG4)
        {
            ...
            do { LATEbits.LATE3 = 1; } while(0);
            do { LATEbits.LATE4 = 0; } while(0);
            do { LATJbits.LATJ4 = 1; } while(0);
            do { LATJbits.LATJ5 = 1; } while(0);
            do { LATJbits.LATJ6 = 0; } while(0);
            do { LATJbits.LATJ7 = 1; } while(0);
        ...
        else if(0 == VOLTDETECT.value && booted){
            if(1 == updateTick){
                DebounceIO(1);
                if(PORTEbits.RE7){
                    tBootWaitTimeCnt++;
        ...
        else if(VOLTDETECT.value && booted)
        {
            if(1 == updateTick){
                ...
                if(1){
                    ...
                    tmp = 0;
                    tmp = (uint8_t)(tmp << 1) | HALL_BLK_13.value;
                    ...
                    tmp = 0;
                    tmp = (uint8_t)(tmp << 1) | HALL_BLK_T7.value;
                    ...
                    tmp = 0;
                    tmp = (uint8_t)(tmp << 1) | OCC_FR_STN_11.value;
                    ...
                    tmp = 0;
                    tmp = (uint8_t)(tmp << 1) | OCC_FR_21B.value;
                    ...
                    do { LATAbits.LATA5 = 1; } while(0);
                    if(CHECKxDATAxINxRECEIVExMAILxBOX() == 1){
