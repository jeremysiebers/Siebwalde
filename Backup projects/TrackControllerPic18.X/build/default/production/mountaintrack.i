...
static _Bool invert = 1;
static _Bool invertExecuted = 0;
...
void UPDATExMOUNTAINxSTATION(MNTSTATION *self)
{
    switch(self->AppState)
    {
        ...
        case INIT:
            ...
            self->stnTrack1.getTrainEnterStnTrack->value = 0;
            self->stnTrack2.getTrainEnterStnTrack->value = 0;
