...
# 5 "mountainStationInbound.c" 2
# 1 "./setocc.h" 1
# 15 "./setocc.h"
    extern void SETxOCC(OCC *self, _Bool value);
# 6 "mountainStationInbound.c" 2
