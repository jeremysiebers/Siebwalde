...
# 6 "mainStationPassing.c" 2
# 1 "./setocc.h" 1
# 15 "./setocc.h"
    extern void SETxOCC(OCC *self, _Bool value);
# 7 "mainStationPassing.c" 2
...
int8_t MAINxSTATIONxPASSING(STATION *self){
    ...
    switch(activeTrack->stnSequence){
        ...
        case SEQ_SET_OCC:
            SETxOCC(activeTrack->setOccStn, 0);
            SETxOCC(self->setOccBlkIn, 0);
        ...
        case SEQ_CHK_PASSED:
            if(0 == activeTrack->getOccStn->value &&
                    1 == self->getOccBlkOut->value){
