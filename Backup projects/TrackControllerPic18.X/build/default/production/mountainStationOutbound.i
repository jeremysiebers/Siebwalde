...
# 5 "mountainStationOutbound.c" 2
# 1 "./setocc.h" 1
# 15 "./setocc.h"
    extern void SETxOCC(OCC *self, _Bool value);
# 6 "mountainStationOutbound.c" 2
...
int8_t MOUNTAINxSTATIONxOUTBOUND(MNTSTATION *self){
    ...
    else if(0 == self->stnTrack1.stnOccupied &&
            0 == self->stnTrack2.stnOccupied){
        return(nop);
    }
    ...
    switch(activeTrack->stnSequence){
        ...
        case SEQ_CHK_TRAIN:
            if(1 == self->getTrainEnterSiebwaldeStn->value ){
                SETxOCC(self->setOccAmpOut, 1);

                activeTrack->getTrainEnterStnTrack->value = 0;
                self->getTrainEnterSiebwaldeStn->value = 0;
