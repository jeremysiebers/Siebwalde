...
# 5 "mainStationInbound.c" 2
# 1 "./setocc.h" 1
# 15 "./setocc.h"
    extern void SETxOCC(OCC *self, _Bool value);
# 6 "mainStationInbound.c" 2
    ...
    switch(activeTrack->stnSequence){
        ...
        case SEQ_CHK_TRAIN:
            if(activeTrack->getOccStn->value){
                SETxOCC(activeTrack->setOccStn, 1);
