...
#define MY_DEFAULT_MAC_BYTE4            (0x10)	// and wish to use the internal
#define MY_DEFAULT_MAC_BYTE5            (0x20)	// factory programmed MAC
...
#define MY_DEFAULT_IP_ADDR_BYTE4        (36ul)
