...
namespace Siebwalde_Application
{
    public class FiddleYardAppInit
    {
        ...
        private enum State
        {
            Idle, Situation1, Situation2, TrainDetection, TrackNotAligned, TrainObstruction, FiddleOneLeftRight, WaitTargetUpdateTrack, Situation2_1, Situation2_2, TrainObstruction_1, TrainObstruction_2
        };
            ...
            switch (State_Machine)
            {
                ...
                case State.TrainObstruction:
                    if (!m_iFYApp.GetFYApp().F10 && !m_iFYApp.GetFYApp().F11 && !m_iFYApp.GetFYApp().F12 && !m_iFYApp.GetFYApp().F13 && !m_iFYApp.GetFYApp().Block6 && !m_iFYApp.GetFYApp().Block7)
                    {
                        ...
                        m_iFYApp.GetFYApp().FiddleYardApplicationLogging.StoreText("Train has left successfully");
                        uControllerReady = false;
