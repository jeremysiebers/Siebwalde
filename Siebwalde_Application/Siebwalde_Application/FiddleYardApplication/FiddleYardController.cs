    ...
    public class FiddleYardController : iFiddleYardController
    {
        ...
        public void Start()
        {
            if (ConnectFiddleYard(m_macAddr, m_ipAddr) == true) // when connection was succesfull and target was found and is connected
            {
                ...
                FYIOHandleTOP.FYApp.FYFORM.FiddleYardFormLogging.StoreText("###Fiddle Yard uController target in real mode###");
                FYIOHandleTOP.FYApp.FYFORM.SimMode(FYSimulatorActive);
                FYIOHandleBOT.FYApp.FYFORM.FiddleYardFormLogging.StoreText("###Fiddle Yard uController target in real mode###");
            ...
            else
            {
                ...
                FYIOHandleTOP.FYApp.FYFORM.FiddleYardFormLogging.StoreText("###Fiddle Yard uController target in simulation mode###");
                FYIOHandleTOP.FYApp.FYFORM.SimMode(FYSimulatorActive);
                FYIOHandleBOT.FYApp.FYFORM.FiddleYardFormLogging.StoreText("###Fiddle Yard uController target in simulation mode###");
                FYIOHandleBOT.FYApp.FYFORM.SimMode(FYSimulatorActive);
            }
