...
namespace Siebwalde_Application
{
    ...
    public class FiddleYardController
    {
        private Receiver _receiver;
        private int _poort;
        private SetTextCallback m_callbackTOP = null;
        private SetTextCallback m_callbackBOT = null;
        ...
        public FiddleYardController(int poort, SetTextCallback callbackTOP, SetTextCallback callbackBOT, ToggleCommLinkCallback Toggle_Comm_Link)
        {
            _poort = poort;
