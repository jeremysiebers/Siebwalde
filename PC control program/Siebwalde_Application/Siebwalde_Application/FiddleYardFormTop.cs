...
namespace Siebwalde_Application
{
    ...
    public delegate void SetTextCallbackBOT(string text, int Layer, int Indicator, int Val);  // defines a delegate type TOP
    ...
    public partial class FiddleYardFormTop : Form
    {
        ...
        public void FYTOPShow()
        {
            ...
            {
                this.Location = new System.Drawing.Point(960, 85);
